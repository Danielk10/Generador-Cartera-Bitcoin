...
Este documento describe la configuración técnica, instalación del SDK de Android, gestión de dependencias, configuración de firma y compilación del proyecto **Generador de Cartera Bitcoin (com.diamon.ganar)**.
...
- **AndroidX & UI:** `appcompat:1.7.1`, `material:1.14.0`, `activity:1.13.0`, `constraintlayout:2.2.1`, `lifecycle:2.10.0`, `bouncycastle:1.84`
...
2. Instala el SDK, NDK (`30.0.14904198`), Build-Tools (`37.0.0`), Platform-Tools y Plataformas Android (23 y 37) en la ruta temporal `/tmp/android-sdk`.
